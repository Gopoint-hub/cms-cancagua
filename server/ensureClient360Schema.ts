...
export async function ensureClient360Schema(): Promise<void> {
  const db = await getDb();
  if (!db) throw new Error("Base de datos no disponible para Clientes 360");
  ...
  console.log("[database] Esquema de Clientes 360 verificado");
}
