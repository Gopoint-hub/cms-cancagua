...
const CREATE_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS sauna_bookings (id int AUTO_INCREMENT PRIMARY KEY, booking_code varchar(40) NOT NULL UNIQUE, skedu_appointment_uuid varchar(64) NULL UNIQUE, skedu_group_uuid varchar(64) NULL, skedu_user_uuid varchar(64) NULL, skedu_service_uuid varchar(64) NULL, service_name varchar(220) NOT NULL, kind enum('shared','private','staff','detox','manual') NOT NULL DEFAULT 'shared', client_name varchar(200) NULL, client_email varchar(320) NULL, client_phone varchar(40) NULL, booking_date date NOT NULL, start_time varchar(5) NOT NULL, end_time varchar(5) NOT NULL, guests int NOT NULL, capacity_used int NOT NULL, is_private int NOT NULL DEFAULT 0, status enum('pending','confirmed','completed','cancelled','no_show') NOT NULL DEFAULT 'confirmed', is_confirmed int NOT NULL DEFAULT 0, payment_status enum('unknown','pending','paid','partially_refunded','refunded') NOT NULL DEFAULT 'unknown', payment_method varchar(60) NULL, payment_reference varchar(160) NULL, amount_clp int NOT NULL DEFAULT 0, source enum('skedu','web','cms','detox') NOT NULL DEFAULT 'cms', origin varchar(40) NULL, reschedule_count int NOT NULL DEFAULT 0, notes text NULL, external_updated_at timestamp NULL, last_synced_at timestamp NULL, cancelled_at timestamp NULL, created_by_user_id int NULL, created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, INDEX sauna_booking_slot_idx (booking_date, start_time, end_time, status), INDEX sauna_booking_source_idx (source, skedu_service_uuid))`,
